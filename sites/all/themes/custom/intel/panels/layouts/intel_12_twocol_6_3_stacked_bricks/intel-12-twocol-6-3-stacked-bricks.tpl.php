<div class="panel-display omega-grid intel-12-twocol-6-3-stacked-bricks" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  <div class="panel-panel grid-9 content-top">
    <div class="inside clearfix">
      <div class="panel-panel grid-6 alpha omega content-left-top">
        <div class="inside"><?php print $content['left_top']; ?></div>
      </div>
      <div class="panel-panel grid-3 alpha omega content-right-top">
